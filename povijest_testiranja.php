...
<body data-spy="scroll" data-target=".navbar" data-offset="150" ng-app="pacijenti-app" ng-controller="pacijentiController">
    ...
    <table class="table table-hover">
        ...
        <select id="filter" ng-model="filtergodina.god">
            ...
            <tbody>
                <tr ng-repeat="pacijent in oPacijenti_povijest_testiranja | filter:searchText | filter:filterzupanije | filter:filterpostarosti('god', filtergodina.god)">
                    <td>{{$index + 1}}</td>
                    <td>{{pacijent.ime}}</td>
                    ...
                    <td><a href="povijest_testovi.php" ng-click="DohvatiOIBTestiranog(pacijent.oib)">
